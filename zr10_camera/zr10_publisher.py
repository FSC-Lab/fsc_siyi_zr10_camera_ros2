...
class ZR10Publisher(Node):
    def __init__(self):
        ...
        # Skip videoconvert — read BGRx directly, drop alpha in numpy
        pipeline = (
        ...
        self.get_logger().info(
            f"Stream opened — {self.target_fps}fps 720p q={self.jpeg_quality}")
    ...
    def capture_loop(self):
        ...
        while self.running and rclpy.ok():
            ...
            # Drop the X channel from BGRx → BGR using numpy slice (fast)
            bgr = frame[:, :, :3]
